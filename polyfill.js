/* This file contains multiple polyfills for old browsers support.
 * Most of them have been taken from StackOverflow, GitHub and MDN.
 */

/**
 * Element.addEventListener polyfill
 *
...
function hasClass(ele, cls) {
    return ele.getAttribute('class') == null ? false : ele.getAttribute('class').indexOf(cls) > -1;
}
